            ...
            <div className="grid gap-6">
              {[
                ...
                },
                {
                  ...
                  description: "Slideshow Agent is an AI-powered presentation system that turns raw spreadsheets into polished, data-driven decks. Instead of just summarizing tables or filling a template, it reads the structure of the workbook, identifies what the data actually supports, and builds a presentation with a real point of view. The goal is to make the output feel less like \"AI slides\" and more like something created by a sharp analyst and a strong designer working together.\n\nBehind the scenes, the product profiles uploaded files, extracts evidence and relationships from the data, and uses GPT-5.4 to generate full web-native slide decks with custom layout, styling, and narrative structure. Charts and visuals are rendered directly for the browser, which makes interactive behavior possible, like hoverable data points and richer visual inspection. A quality pipeline then checks fit, readability, structure, and visual consistency before a deck is accepted, so the system is optimizing not just for automation, but for presentation quality.",
